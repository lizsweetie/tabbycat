...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (TabbyCatError *types.TabbyCatError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, TabbyCatErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if TabbyCatErr != nil {
			return TabbyCatErr
		}
