...
import (
	...
	"github.com/QuantumNous/tabbycat/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.TabbyCatError) {
	if info.IsStream {
