...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.TabbyCatError {
	...
	key, index, TabbyCatError := channel.GetNextEnabledKey()
