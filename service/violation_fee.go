...
func HasCSAMViolationMarker(err *types.TabbyCatError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.TabbyCatError) *types.TabbyCatError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.TabbyCatError) *types.TabbyCatError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.TabbyCatError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.TabbyCatError) bool {
