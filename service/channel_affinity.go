...
import (
	...
	"github.com/QuantumNous/tabbycat/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "tabbycat:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "tabbycat:channel_affinity_usage_cache_stats:v1"
)
